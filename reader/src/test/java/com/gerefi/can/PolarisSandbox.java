...
public class PolarisSandbox {
    public static void main(String[] args) throws IOException {
        ...
        String noEcuFile = "C:\\stuff\\gerefi_documentation\\OEM-Docs\\Polaris\\2021-can\\no-ecu.trc";
        List<CANPacket> noEcuPackets = reader.readFile(noEcuFile);
        Set<Integer> noEcuIds = printStats(noEcuPackets, "NO ECU");

        String idleFile = "C:\\stuff\\gerefi_documentation\\OEM-Docs\\Polaris\\2021-can\\parking-revving-1500-3000.trc";
